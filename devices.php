      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form action="" method="post" enctype="multipart/form-data">
            ...
            <label>Department: 
                <select class="newDeptSel" name="newDeptSel" id="newDeptSel">
...
$(document).on('click', '#add_dev', function(){
    ...
    var dev_dep= $('#newDeptSel').val();

    jQuery.ajax({
            url:'deviceConfig.php',
            data: {dev_add:1, dev_room:dev_room, dev_dep:dev_dep},
            type:'post',
            success: function(data){
                if(data==0 ){
                    ...
                    $('#modal .modal-title').html("..Ooppss");
                    $('#modal .modal-body').html("Please select department.");
                    $('#modal').modal('show');
