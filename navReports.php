...
$(document).ready(function(){
    ...
    $(document).on('click', '#viewSuspectBtn',function(){
        ...
        jQuery.ajax({
            url:'navReportsSus-config.php',
            data: {viewstat:1},
            type: 'POST',
            dataType: 'text',
            success:function(data){
                if (data=='0'){
                   $('#viewSuspectedModal .modal-body').html('No record found');
                   $('#viewSuspectedModal').modal('show');
                }
                else{
                    jQuery.ajax({
                        url:'navReportsSus-load.php',
                        dataType:'text',
